 ...
 * Time converts between min sec and houer, it also formats the time string.
 */
public class Time {
	...
	public String toUSStandard() {
		return String.format("%d:%02d:%02d %s", ((getHouer() == 0 || getHouer()
				== 12) ? 12 : getHouer()), getMinute(), getSecound(), ((getHouer()
				< 12) ? "AM" : "PM"));
	}
}
